...
def extrapolation(time, hamiltonian, eigenstate, expected, num_qubit=2):
    ...
    for n in range(2, 8, 2):  # number of the Chebyshev nodes
...
if __name__ == '__main__':
    ...
    extrapolation(time, hamiltonian, eigenstate, eigenvalues[0])
